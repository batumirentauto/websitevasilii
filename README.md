# websitevasilii — Payload CMS 3.0

Проект веб-сайта на базе **Payload CMS 3.0** (Next.js 15 App Router, TypeScript, Tailwind CSS, PostgreSQL). Основан на официальном шаблоне [Payload Website Template](https://github.com/payloadcms/payload/tree/main/templates/website).
